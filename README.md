...
- **Android:** For users on Android smartphones.

### 3. Download the App
Click the appropriate link to download the application.

- For iOS, you'll find a `.ipa` file.
- For Android, you'll find an `.apk` file.

### 4. Install the Application
#### For iOS Users:
1. Open the downloaded `.ipa` file.
2. Follow the on-screen instructions to install the app on your device. You may need to trust the developer in your device settings.

#### For Android Users:
1. Open the `.apk` file after the download completes.
2. You may need to enable installations from unknown sources in your device settings.
3. Follow the prompts to install the app.

### 5. Launch OnDeviceAI
Once installed, find the OnDeviceAI app icon in your app drawer or home screen. Tap on the icon to launch the application.

## 🔍 Features
OnDeviceAI offers the following features:

- **On-Device AI Processing:** Process your data without relying on internet connectivity.
- **Fast Performance:** Leverage Kotlin Multiplatform for enhanced performance across platforms.
- **Easy Integration:** Easily integrate on-device AI functionalities into your own projects.
- **Minimal Interface:** User-friendly design that is easy to navigate.

## 📋 System Requirements
### iOS
- Supported devices: iPhone 8 and later, iPad 5th generation and later
- OS: iOS 14 or later

### Android
- Supported devices: Android 8.0 (Oreo) and later
- OS: Any modern Android device
